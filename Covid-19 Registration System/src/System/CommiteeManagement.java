...
//                allCommitee.clear();            //if no clear, will always add record into arraylisy, cannot identify duplicates
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CommiteeManagement.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CommiteeManagement().setVisible(true);
            }
        });
    }
    ...
    public void AutoNumber() {
        ...
        try {
            ...
            Logger.getLogger(CommiteeManagement.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
